...
perkenalan("Reza","Aditya")
perkenalan("Callysta","Maura")

print()

perkenalan(namaDepan = "Reza2", namaBelakang = "Aditya2")
perkenalan(namaBelakang = "Callysta2", namaDepan = "Maura2")
...
introduction(firstName="Reza")
introduction(firstName="Reza", lastName="Aditya")
introduction("Reza", lastName="Aditya")
...
#Call the Function here
introductionLengkap(firstName="Reza", lastName="Aditya", middleName="Prabowo")
